	...
	public partial class Autofarm : Form {
		...
		private void Autofarmer_Load(object sender, EventArgs e) {
			...
			foreach (Process sortedProcess in sortedProcesses) {
				...
				processList.Rows[processes.Count - 1].Cells["Active"].Value = "Off";
				...
				System.Threading.Tasks.Parallel.ForEach(processes, p => {
					...
					if (magplantAutofarmer.Contains(pNum)) {
						...
						switch(mags)
                        {
							...
							case 2:  //one block up
                                {
									SendClick(p, 500, 220);      //one block up
									break;
                                }
							case 3:
                                {
        ...
        private void autoFarmerType_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void settingsLabel1_Click(object sender, EventArgs e)
        {
        ...
        private void Autofarm_MouseDown(object sender, MouseEventArgs e)
        {
			ReleaseCapture();
        ...
        private void fileNameDisplayer_TextChanged(object sender, EventArgs e)
        {
